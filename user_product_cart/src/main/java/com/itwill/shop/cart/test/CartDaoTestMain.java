...
public class CartDaoTestMain {
	public static void main(String[] args) throws Exception{
		...
		System.out.println(cartDao.cartProductCount(new CartItem(0, 0, 
				new Product(7, null, 0, null, null, 0), "guard3")));
		...
		System.out.println(cartDao.updateByProductNoAndUserId
				(new CartItem(0, 3, new Product(1, null, 0, null, null, 0), "guard1")));
	}
}
