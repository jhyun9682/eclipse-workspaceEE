...
<script type="text/javascript">
	function userCreate() {
		...
		//String.includes('찾을 단어', 읽기 시작할 index 값 없을시 전체)
		//찾을 단어가 있을 시 true 없으면 false
		if (document.f.phone.value.includes('-')) {
			alert("핸드폰 번호에는 숫자만 입력해주세요.");
			f.phone.focus();
			return false;
		}
		document.f.action = "memberJoinAction.jsp";
	...
	*/
	function openIdCheck(){
		window.open('memberIdCheck.jsp','checkForm','width=500,height=300,resizable = no,scrollbar = no');
	}
								...
								<table border="0" cellpadding="0" cellspacing="1" width="590"
									...
									<tr>
										...
										<td width=490 bgcolor="ffffff" style="padding-left: 10px" align="left">
											<input onclick="openIdCheck();" type="text" style="width: 150px"
											 name="memberId" value="" readonly="readonly">&nbsp;&nbsp;
