...
CREATE TABLE categorys(
		...
		category_class                		VARCHAR2(50)		 NULL 
);

DROP SEQUENCE categorys_category_no_SEQ;

CREATE SEQUENCE categorys_category_no_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;
...
ALTER TABLE categorys ADD CONSTRAINT IDX_categorys_PK PRIMARY KEY (category_no);

ALTER TABLE book ADD CONSTRAINT IDX_book_PK PRIMARY KEY (b_no);
ALTER TABLE book ADD CONSTRAINT IDX_book_FK0 FOREIGN KEY (category_no) REFERENCES categorys (category_no);
...
ALTER TABLE ebook ADD CONSTRAINT IDX_ebook_FK0 FOREIGN KEY (u_id) REFERENCES userinfo (u_id);
ALTER TABLE ebook ADD CONSTRAINT IDX_ebook_FK1 FOREIGN KEY (b_no) REFERENCES book (b_no);
