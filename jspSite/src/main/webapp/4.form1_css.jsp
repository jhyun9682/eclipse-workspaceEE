...
<body style="background-color: aliceblue;color:#555555">
	<br />
	<br />
	<br />
	<h1 style="color: maroon;" align="center">회원가입</h1>
	<form action="4.join1.jsp" method="post" style="color:navy;border:1px solid black;width:700px;margin: 0 auto 0 auto">
