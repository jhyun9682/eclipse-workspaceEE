...
<script type="text/javascript">
	...
	function order_create_form() {
		if (<%=!isLogin%>) {
			...
			document.product_detail_form.c_qty.value = document.add_cart_form.c_qty.value;
...
<body bgcolor=#FFFFFF text=#000000 leftmargin=0 topmargin=0
	...
	<form name="product_detail_form">
		<input type="hidden" name="c_no" value="<%=product.getP_no()%>">  
		<input type="hidden" name="c_qty" > <input
							...
							<table style="margin-left: 10px" border=0 width=80% height=376
								...
								<tr valign=bottom>
									...
									<td width=40% align=center class=t1><font size=2
										color=#0000FF><b>제품이름</b></font></td>
									<td width=30% align=center class=t1><font size=2
										color=#0000FF><b>제품소개</b></font></td>
								</tr>
								<tr width=100%>
