...
<script type="text/javascript">
	function qna_insert() {
		...
		f.action = "qna_insert_action.jsp";
		f.method="POST";
		f.submit();
	}
					...
					<tr>
						<td><br />
							...
							<form name="f" method="post">
								<table border="0" cellpadding="0" cellspacing="1" width="590"
									...
									<tr>
										...
										<td width=490 bgcolor="ffffff" style="padding-left: 10px"
								 			align="left"><input type="text" style="width: 150px"
											name="writer" value="<%=sM_id%>" readonly></td>
									</tr>
									<tr>
							...
							<table width=590 border=0 cellpadding=0 cellspacing=0>
								<tr>
									<td align=center><input type="button" value="게시글 등록"
										onClick="qna_insert()"> &nbsp; <input type="button"
										value="게시판 목록" onClick="qna_list()"></td>
								</tr>
							</table></td>
					</tr>
				</table>
