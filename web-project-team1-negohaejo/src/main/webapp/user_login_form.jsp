...
<script type="text/javascript">
	...
	function login() {
		if (f.u_id.value == "") {
			alert("아이디를 입력하세요.");
			f.u_id.focus(); //userId부분을 u_id로 변경
			return false;
		}
		if (f.u_password.value == "") {
			alert("비밀번호를 입력하세요.");
			f.u_password.focus(); //password를 u_password로 변경
			return false;
		}
						...
						<td><br />
							...
							<form name="f" method="post">
								<table border="0" cellpadding="0" cellspacing="1"
									bgcolor="BBBBBB">
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">아 이 디</td>
									...
									<tr>
										...
										<td width=490 align="left" bgcolor="ffffff"
											...
											style="width: 150" name="u_password"
											value="">&nbsp;&nbsp;<font
											color="red"></font></td>
									</tr>
								</table>
