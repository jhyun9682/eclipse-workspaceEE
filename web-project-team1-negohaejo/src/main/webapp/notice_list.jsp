<%@page import="com.itwill.shop.dto.PageInputDto"%>
...
public String getTitleString(Notice notice) {
	...
	String t = notice.getNoti_title();
	if(t.length()>25){
		t = String.format("%s...", t.substring(0,25));
	}
							...
							<form name="f" method="post" action="">
								<table border="0" cellpadding="0" cellspacing="1" width="590"
									...
									<tr>
										...
										<a href='notice_view.jsp?notino=<%=notice.getNoti_no()%>&pageno=<%=noticeListPage.pageMaker.getCurPage()%>'>
								...
								<tr>
									<td align="center">
										...
										<%
										 ...
										 <%if(noticeListPage.pageMaker.getNextGroupStartPage()< noticeListPage.pageMaker.getTotPage()){%>
										<a
										href="./notice_list.jsp?pageno=<%=noticeListPage.pageMaker.getTotPage()%>">▶▶</a>&nbsp;
										 <%}%>
									</td>
								</tr>
							</table> <!-- button -->
