...
DROP SEQUENCE oi_oi_no_SEQ;

CREATE SEQUENCE oi_oi_no_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;

DROP SEQUENCE o_o_no_SEQ;

CREATE SEQUENCE o_o_no_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;

DROP SEQUENCE rv_rv_no_SEQ;

CREATE SEQUENCE rv_rv_no_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;

DROP SEQUENCE not_not_no_SEQ;

CREATE SEQUENCE not_not_no_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;
...
ALTER TABLE purchase ADD CONSTRAINT IDX_purchase_FK0 FOREIGN KEY (U_ID) REFERENCES USERINFO (U_ID) on DELETE SET NULL;

ALTER TABLE PURCHASE_ITEM ADD CONSTRAINT IDX_PURCHASE_ITEM_PK PRIMARY KEY (OI_NO);
ALTER TABLE PURCHASE_ITEM ADD CONSTRAINT IDX_PURCHASE_ITEM_FK0 FOREIGN KEY (o_No) REFERENCES purchase (o_No) ON DELETE CASCADE;
...
ALTER TABLE review ADD CONSTRAINT IDX_review_FK1 FOREIGN KEY (p_no) REFERENCES PRODUCT2 (p_no) ON DELETE CASCADE;
ALTER TABLE review ADD CONSTRAINT IDX_review_FK2 FOREIGN KEY (OI_NO) REFERENCES PURCHASE_ITEM (OI_NO) on delete SET NULL;
