...
public class AddressUpdateFormServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			out.println("</head>");
			out.println("<body>");
			out.println("<h571>[김경호님 주소록 수정폼]</h1><hr>");
			out.println("<hr>");
			out.println("	<div>");
			...
			out.println("		번호----<input type='text' readonly='readonly' name='no' value='" + address.getNo()
					+ "'><br>");
			out.println("		아이디--<input type='text' readonly='readonly' name='id' value='" + address.getId()
					+ "'><br>");
